    ...
    return `
        <form id="sendCreditForm" class="text-right">
            ...
            <div class="form-control">
                ...
                <input autofocus name="to" placeholder="receiver's username" required class="bg-base-300 input input-md m-1" />
            </div>
            <div class="form-control">
...
export function PostContentView(account: any, session: any) {
    ...
    <form id="postForm" class="text-right">
        ...
        <div class="form-control">
            ...
            <textarea class="bg-base-300 textarea textarea-md" name="content" rows="4" cols="60" placeholder="Optional details"></textarea>
        </div>
...
export function Modals(session, account) {
    return `
            ...
            <div class="modal-box">
                ...
                <form id="updateBioForm" class="">
                    <div class="form-control mb-2">
                        <textarea autofocus name="bio" row="4" class="textarea w-full bg-base-300" placeholder="Write description of this account.">${account.bio ? account.bio : ''}</textarea>
                    </div>
        ...
        <dialog id="contentModal" class="modal">
            <div class="modal-box">
                <form method="dialog">
                    <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                </form>
