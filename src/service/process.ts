...
export function processResources(): void {
    ...
    const adjustedWaterRate = waterRate * (1 - Math.floor(current.resources.water.balance / 100) * 0.5)
    ...
    const adjustedMineralRate = mineralRate * (1 - Math.floor(current.resources.mineral.balance / 100) * 0.5)
