...
export function processResources(): void {
    ...
    const adjustedWaterRate = waterRate * (1 - (current.resources.water.balance / 33) * 0.05)
    ...
    const adjustedMineralRate = mineralRate * (1 - (current.resources.mineral.balance / 33) * 0.05)
